...
{"matches":[{"keyword":"채용공고 원문 문구","painPoint":"아픈 지점 설명","proposal":"제안 방향"}],"fitnessPercent":75}

규칙:
- keyword는 채용공고 원문에서 그대로 복사한 짧은 문구(5~20자)여야 합니다. 원문에 없는 문구는 절대 사용하지 마세요.
- matches는 3~5개 찾으세요
- fitnessPercent는 지원자 적합도 (0~100)`;
